...
/**
 * Created by DungNguyen on 9/7/16.
 */
public class SaleAdapter extends BaseAdapter {
    ...
    public SaleAdapter(Context context, ArrayList<SaleListData> myList) {
        this.myList = myList;
    ...
    @Override
    public SaleListData getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SaleListData currentListData = getItem(position);
