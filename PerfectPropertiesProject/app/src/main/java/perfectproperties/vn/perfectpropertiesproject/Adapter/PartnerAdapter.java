...
import perfectproperties.vn.perfectpropertiesproject.Entity.PartnerListData;
...
public class PartnerAdapter extends BaseAdapter {
    ...
    ArrayList<PartnerListData> myList = new ArrayList<PartnerListData>();
    LayoutInflater inflater;
    Context context;


    public PartnerAdapter (Context context, ArrayList<PartnerListData> myList) {
        this.myList = myList;
    ...
    @Override
    public PartnerListData getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PartnerListData currentListData = getItem(position);
